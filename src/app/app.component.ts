...
export class AppComponent {
  ...
  setDefaultUser(){
    this.almacenamientoNativoService.almacenarUsuarioPorDefault({fullName:"Area TI",username:"areati",password:'areati',actions:[ACTIONS.ACCESO_A_CONFIGURACIONES,
      ACTIONS.EDITAR_REGISTROS_TRAMPAS,ACTIONS.AGREGAR_REGISTROS_TRAMPAS,
      ACTIONS.EDITAR_REGISTROS_TRASPATIOS_FINCAS,ACTIONS.AGREGAR_REGISTROS_TRASPATIOS_FINCAS,
      ACTIONS.EDITAR_REGISTROS_INSP_TRASPATIOS_FINCAS,ACTIONS.AGREGAR_REGISTROS_INSP_TRASPATIOS_FINCAS,
      ACTIONS.EDITAR_REGISTROS_INSP_TRAMPAS,ACTIONS.AGREGAR_REGISTROS_INSP_TRAMPAS,ACTIONS.EDITAR_MARCA_A_INSPECCION
  ],token:''}).then((usuario)=>{
  ...
  logueoPaPruebas(){
    let user = {
      ...
      password:"Az123456",
      actions:[ACTIONS.ACCESO_A_CONFIGURACIONES,
        ACTIONS.EDITAR_REGISTROS_TRAMPAS,ACTIONS.AGREGAR_REGISTROS_TRAMPAS,
        ACTIONS.EDITAR_REGISTROS_TRASPATIOS_FINCAS,ACTIONS.AGREGAR_REGISTROS_TRASPATIOS_FINCAS,
        ACTIONS.EDITAR_REGISTROS_INSP_TRASPATIOS_FINCAS,ACTIONS.AGREGAR_REGISTROS_INSP_TRASPATIOS_FINCAS,
        ACTIONS.EDITAR_REGISTROS_INSP_TRAMPAS,ACTIONS.AGREGAR_REGISTROS_INSP_TRAMPAS,ACTIONS.EDITAR_MARCA_A_INSPECCION
